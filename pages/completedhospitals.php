                                ...
                                <div class="portlet-content">						
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table 
                                            ...
                                            <tbody>
                                                <?php
                                               $users_list = DB::getInstance()->query("SELECT hname, haddress, hdirectorname, hdirectorqualif, hdirectorphone, level, type , staffname, staffqualif,
														Status FROM hospitals INNER JOIN assignhospital WHERE hospitals.hospital_id = assignhospital.hospital_id && Status='Completed'");
...
<td><?php echo $users_list->Status;  ?> </a>
